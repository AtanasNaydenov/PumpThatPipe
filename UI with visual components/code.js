...
function init() {
    ...
    myDiagram.linkTemplate =
        ...
        shadowOffset: new go.Point(0, 0), shadowBlur: 5, shadowColor: "orange",
    },
    ...
    var mergerimage=
        $(go.Node,"Vertical",nodeStyle(),
            $(go.Panel, "Auto",
                $(go.Panel, "Vertical",
                    $(go.Picture,"Components/merger2.png",{width:34,height:34})),
                $(go.Shape, "Rectangle", portStyleMerger(true),
                    { portId: "in1", alignment: new go.Spot(0, -0.2) }),
                $(go.Shape, "Rectangle", portStyleMerger(true),
                    { portId: "in2", alignment: new go.Spot(0, 1.2) }),
                $(go.Shape, "Rectangle", portStyleSplitter(false),
                    { portId: "out", alignment: new go.Spot(1, 0.5) })
    ...
    var splitterimage=
        $(go.Node,"Vertical",nodeStyle(),
            $(go.Panel, "Auto",
                $(go.Panel, "Vertical",
                    $(go.Picture,"Components/splitter2.png",{width:34,height:34})),
                $(go.Shape, "Rectangle", portStyleMerger(true),
                    { portId: "in", alignment: new go.Spot(0, 0.8) }),
                $(go.Shape, "Rectangle", portStyleSplitter(false),
                    { portId: "out1", alignment: new go.Spot(1, -0.2) }),
                $(go.Shape, "Rectangle", portStyleSplitter(false),
                    { portId: "out2", alignment: new go.Spot(1, 1.2) })
            ));
    ...
    var asplitterimage=
        $(go.Node,"Vertical",nodeStyle(),
            $(go.Panel, "Auto",
                $(go.Panel, "Vertical",
                    $(go.Picture,"Components/asplitter2.png",{width:34,height:34})),
                $(go.Shape, "Rectangle", portStyleMerger(true),
                    { portId: "in", alignment: new go.Spot(0, 0.8) }),
                $(go.Shape, "Rectangle", portStyleSplitter(false),
                    { portId: "out1", alignment: new go.Spot(1, -0.2) }),
    ...
    var sinkimage=
        $(go.Node,"Vertical",nodeStyle(),
            $(go.Panel, "Auto",
                $(go.Panel, "Vertical",
                    $(go.Picture,"Components/sink2.png",{width:34,height:34})),
...
function updateStates() {
    ...
    myDiagram.nodes.each(function(node) {
        switch (node.category) {
            case "pump":   doPump(node); break;
            case "merger":   doMerger(node); break;
            case "splitter":   doSplitter(node); break;
            case "asplitter":   doAsplitter(node); break;
            case "sink":   doSink(node); break;
        }
    });
